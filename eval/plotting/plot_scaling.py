...
def main():
    ...
    e3_grid = load_e3_grid(os.path.join(EVAL, "scaling_input_size.csv"))
    ...
    extras = [
        ("scaling_party_count_controlled.csv", lambda p: plot_e4b(load_e4b(p), "fig_e4b_party_scaling.pdf")),
        ("scaling_input_size_superseded.csv", lambda p: plot(
            load_scaling(p, "n_per_party_cap"), "Cases per party", "Wall time (s)",
            "E3 input scaling", "fig_e3_input_scaling.pdf")),
        ("scaling_party_count.csv", lambda p: plot(
